...
public class Logger {
    ...
    @AfterThrowing(pointcut = "execution(public * com.example.thuchanh1.service.CustomerService.findAll(..))", throwing = "e")
    public void logMethod(Exception e) {
        System.out.println("[CMS] co loi xay ra: " + e.getMessage());
    }

    @AfterThrowing(pointcut = "execution(public * com.example.thuchanh1.service.CustomerService.*(..))", throwing = "e")
